...
################################################################################
## Form generated from reading UI file 'consolednHAfn.ui'
##
...
"}")
    ...
    def retranslateUi(self, ConsoleWidget):
        ...
        self.clear_console_btn.setText(QCoreApplication.translate("ConsoleWidget", u"Clear", None))
    # retranslateUi
